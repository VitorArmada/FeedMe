...
namespace System.ComponentModel.DataAnnotations
{
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
      return ValidationResult.Success;
		...
		public UniqueAttribute() : this(typeof(FeedMe.Models.DatabaseContext)) { }
		...
		protected override ValidationResult IsValid ( object value, ValidationContext validationContext )
		{
			...
			var property = type.GetProperty(validationContext.DisplayName);
			...
			using ( var dbcontext = (IDisposable) Activator.CreateInstance(_ContextType) )
			{
				...
				return isValid ?
				  ...
				  new ValidationResult(
					string.Format("Já existe um(a) '{0}' com esse valor.",
